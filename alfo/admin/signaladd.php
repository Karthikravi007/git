...
<form  id="signupform" action="signalsave.php" method="post" enctype="multipart/form-data">
   <div class="form-group">
    <label for="exampleInputPassword1">Course category</label>
    <input type="text" class="form-control" name="signalcategory" id="exampleInputPassword1" placeholder="Course category">
  </div>
