...
if($_GET['delete']) { 
 ...
 $res = $db_handle->runQuery("DELETE FROM signal_course WHERE id=$id");


 echo '<script>alert(" Deleted successfully"); 
 window.location.href="signalcourse.php";</script>';
	            ...
	            <div class="card-content  collapse show">
	                <div class="card-body card-dashboard">
						<div class="table-responsive">
						    <a href="scourseadd.php"><button class="button">ADD</button></a>
                      ...
                      <?php
$result = $db_handle->runQuery("select * from signal_course");
foreach($result as $row) { ?>
                        <tr>
                           ...
                           $res = $db_handle->runQuery("select * from signal_category where id='".$row['category']."'");
                           foreach($res as $r) {  
                           ...
                           echo $r['category']; 
                              ...
                              <th><img src="<?php echo $row['image'];?>" style="height:50px;width:50px;"></th>
                               <th><a href="scourseedit.php?id=<?php echo $row['id']; ?>"><i style="font-size: 20px;padding-right: 10px;" class="ft-edit"></i></a> 
