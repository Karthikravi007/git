...
<form id="signupform"  action="scourseupdate.php" method="post" enctype="multipart/form-data">
  <div class="form-group">
    ...
    <?php
$cat = $db_handle->runQuery("select * from signal_category");
foreach($cat as $c) { ?>
      <option value="<?php echo $c['id'];?>" <?php if($row['category']== $c['id']){ echo 'selected';}?>><?php echo $c['category'];?></option>
  ...
  <div class="custom-file">
    ...
    <img src="<?php echo $row['image'];?>" style="width: 32%;">
