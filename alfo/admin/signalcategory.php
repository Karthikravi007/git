...
if($_GET['delete']) { 
 ...
 $res = $db_handle->runQuery("DELETE FROM signal_category WHERE id=$id");


 echo '<script>alert(" Deleted successfully"); 
 window.location.href="signal.php";</script>';
	            ...
	            <div class="card-content  collapse show">
	                <div class="card-body card-dashboard">
						<div class="table-responsive">
						    <a href="signaladd.php"><button class="button">ADD</button></a>
			                <table class="table table-striped table-bordered sourced-data">
                              ...
                              <th>Action</th>
							        ...
							        <?php
$result = $db_handle->runQuery("select * from signal_category");
foreach($result as $row) { ?>
                        <tr>
                           <th><?php echo $row['id'];?></th>
							                <th><?php echo $row['category']?></th>
                              <th><img src="<?php echo $row['image'];?>" style="height:50px;width:50px;"></th>
                              <th><a href="signaledit.php?id=<?php echo $row['id']; ?>"><i style="font-size: 20px;padding-right: 10px;" class="ft-edit"></i></a> 
