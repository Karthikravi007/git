...
include("db.php");
    ...
    for( $i=0 ; $i < $total ; $i++ ) {
      ...
      if ($tmpFilePath != ""){
       ...
       // echo "INSERT INTO `bot_category` (`id`,`image`,`category`)
        //values(NULL,'".$newFilePath."','".$category."')";exit;
...
//values(NULL,'".$newFilePath."','".$coursecat."','".$coursetit."','".$courseprice."','".$coursedetails."','".$coursedes."')";exit;
        ...
        if(move_uploaded_file($tmpFilePath, $newFilePath)) {
            ...
            $result = $db_handle->runQuery("INSERT INTO `bot_category` (`id`,`image`,`category`)
