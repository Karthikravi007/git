...
if($_GET['delete']) { 
 ...
 $res = $db_handle->runQuery("DELETE FROM course WHERE id=$id");
	            ...
	            <div class="card-content  collapse show">
	                <div class="card-body card-dashboard">
						<div class="table-responsive">
						    <a href="add.php"><button class="button">ADD</button></a>
                      ...
                      <?php
$result = $db_handle->runQuery("select * from course");
foreach($result as $row) { ?>
                        <tr>
                           ...
                           echo $r['course_name']; 
							                ...
							                <th><?php echo $row['course_title'];?></th>
							                <th><?php echo $row['course_price'];?></th>
							                <th><?php echo $row['course_details'];?></th>
                              <th><?php echo $row['course_description'];?></th>
                              <th><img src="<?php echo $row['image'];?>" style="height:50px;width:50px;"></th>
                              <th><a href="courseedit.php?id=<?php echo $row['id']; ?>"><i style="font-size: 20px;padding-right: 10px;" class="ft-edit"></i></a> 
