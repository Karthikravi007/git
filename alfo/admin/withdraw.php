...
if($_GET['decline']) { 
 ...
 $res = $db_handle->runQuery("update  payment set `status`='2' WHERE id=$id");
 ...
 $res = $db_handle->runQuery("update  payment set `status`='1' WHERE id=$id");
      ...
      <div class="content-wrapper">
        ...
        <div class="content-header row">
          <div class="content-header-left col-md-4 col-12 mb-2">
            <h3 class="content-header-title">ALFOTRO Data Table</h3>
          </div>
        </div>
	        ...
	        <div class="card">
	            ...
	            <div class="card-content  collapse show">
	                <div class="card-body card-dashboard">
                      ...
                      <?php
$result = $db_handle->runQuery("select * from payment where status ='0'");
                        ...
                        <th><?php echo $row['id'];?></th>
                           ...
                           foreach($res as $r) {  
                              ...
                              <th><img src="../img/<?php echo $row['image'];?>" style="height:50px;width:50px;"></th>
							                <th>
                                <a href="?accept=<?php echo $row['id'];?>"><button class="accept">Accept</button> </a>
