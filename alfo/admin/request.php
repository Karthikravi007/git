...
if($_GET['delete']) { 
   ...
   $res = $db_handle->runQuery("DELETE FROM `user_profile` WHERE id=$id");
  
  
   echo '<script>alert(" Deleted successfully"); 
   window.location.href="../users/wallet.php";</script>';
			                ...
			                <table class="table table-striped table-bordered sourced-data">
							        <thead>
							            <tr>
                                            ...
                                            <th>Bank Name</th>
							                <th>Account No</th>
                                            <th>Reenter Account No</th>
							                <th>IFSC Code</th>
                                            <th>Action</th>
							            </tr>
							        </thead>
                      <?php 
$result = $db_handle->runQuery("select * from user_profile");
foreach($result as $row) { ?>
                        <tr>
                           <th><?php echo $row['id'];?></th>
							                <th><?php echo $row['bank'];?></th>
							                <th><?php echo $row['account_number'];?></th>
							                <th><?php echo $row['reenter_number'];?></th>
