...
if($_GET['delete']) { 
 ...
 $res = $db_handle->runQuery("DELETE FROM bot_category WHERE id=$id");
	            ...
	            <div class="card-content  collapse show">
	                <div class="card-body card-dashboard">
						<div class="table-responsive">
						    <a href="bot_add.php"><button class="button">ADD</button></a>
...
foreach($result as $row) { ?>
                        <tr>
                           <th><?php echo $row['id'];?></th>
                              ...
                              <th><a href="bot_edit.php?id=<?php echo $row['id']; ?>"><i style="font-size: 20px;padding-right: 10px;" class="ft-edit"></i></a> 
