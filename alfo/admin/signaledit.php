...
<!-- END: Main Menu-->
    ...
    <?php
    //echo $_GET['id'] ;
$result = $db_handle->runQuery("select * from signal_category where id='".$_GET['id']."' ");
foreach($result as $row) { ?>
<form  id="signupform" action="signalupdate.php" method="post" enctype="multipart/form-data">
   <div class="form-group">
    <label for="exampleInputPassword1">Course category</label>
    <input type="text" class="form-control" name="edit_category" value="<?php echo $row['category'];?>" required id="exampleInputPassword1" placeholder="Course category">
  </div>
