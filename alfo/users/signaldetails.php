...
.details span{
  ...
  font-weight:600;
    ...
    <div class="container">
    <?php
$result = $db_handle->runQuery("select * from signal_course where id='".$_GET['id']."'");
...
<div class="col-md-6">
  <h5 class="details">Course Category : <span><?php
...
foreach($res as $r) { echo $r['category']; } ?></span></h5>
  ...
  <a href="buy.php"><button style="margin-top:2%;padding-left: 20px;padding-right: 20px;font-weight: 500;" 
  type="submit" class="btn btn-primary">Buy</button></a>
