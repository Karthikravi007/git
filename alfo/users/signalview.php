...
$result = $db_handle->runQuery("select `id`,`course`,`image` from `signal_course` where category='".$_GET['id']."'");
foreach($result as $row) { ?>
<div class="col-md-3">
<div class="card">
<img src="../admin/<?php echo $row['image'];?>" style="width: 253px;;height:200px;">
<p class="category"><?php echo $row['course'];?></p>
<a href="signaldetails.php?id=<?php echo $row['id'];?>"><button class="button">View</button></a>
</div>
