...
if($_GET['delete']) { 
 ...
 $res = $db_handle->runQuery("DELETE FROM bank_details WHERE id=$id");
	            ...
	            <div class="card-content  collapse show">
	                <div class="card-body card-dashboard">
						<div class="table-responsive">
						    <!-- <a href="addbank.php"><button class="button">ADD</button></a> -->
                      ...
                      <?php 
$result = $db_handle->runQuery("select * from refreal");
foreach($result as $row) { 
    $UserName = $row['user_id'];
    // echo  $UserName;exit;
    $result1 = $db_handle->runQuery("select * from registration where id= $UserName ");
    // print_r($result1);exit;
    foreach($result1 as $row1){
        $RegId = $row1['name'];
        $referalId=$row1['refferal']; 
    }
    ?>
                        ...
                        <tr>
                              ...
                              <th><?php echo $row['referedId'];?></th>
							                <th><?php echo $row['refername'];?></th>
							                <th><?php echo $row['referal'];?></th>
							                <th><?php echo $row['amount'];?></th>
                                            <th><?php echo $row['commision'];?></th>
