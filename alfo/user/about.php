...
.page-header {
    background: url(./assets/slider4.jpg);
        background-position-x: 0%;
        background-position-y: 0%;
        background-size: auto;
    background-size: cover;
...
.footer-section.home-four {
    background: url(./assets/slider2.jpg);
        background-position-x: 0%;
        background-position-y: 0%;
...
<a class="nav-brand" href="index.html"><img src="assets/logo.png" alt=""></a>
...
<div class="dopenav">
    ...
    <li><a href="price.html">Plan</a></li>
...
<a class="nav-link" id="v-pills-vision-tab" data-toggle="pill" href="#v-pills-vision" role="tab" aria-controls="v-pills-vision" aria-selected="false">
...
<p>Web Developer</p>
<ul>
<li><a href="https://facebook.com/"><i class="icofont-facebook"></i></a></li>
...
<footer class="footer-section section-gap-top home-four">
    
    <div class="container">
    <div class="row footer-top d-flex justify-content-between">
    <div class="col-lg-4 col-md-6 col-6 footer-widgets">
    <img class="footer-logo" src="./assets/logo.png" width="50%" alt=>
